class ArchivesController < ApplicationController
  ...
  def create
    ...
    @archive = @student.archive.create(archive_params)
  ...
  private
    ...
    def archive_params
      params.require(:archive).permit(:archiveno, :student_id, :jiyaono, :issend, :sendway, :isduyan, :firstsend, :secondsend, :hmaterial, :umaterial, :mmaterial, :dmaterial, :pmaterial, :omaterial, :zmaterial, :remark)
    end
end
